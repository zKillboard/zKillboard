...
$message = ($redis->get("tqCountInt") == 0 || Status::getStatus('esi', false) >= 25) ? "<a href='/ztop/'>We seem to be having an issue accessing the ESI API, nothing can be done at this time.</a>" : "";
