...
if ($serverStatus == null) $serverStatus = "OFFLINE";
else $serverStatus = strtoupper($serverStatus);
$loggedIn = (int) @$root["userCounts"]["eve"];

if ($loggedIn == 0) $loggedIn = $serverStatus;
else $loggedIn = number_format($loggedIn, 0);
