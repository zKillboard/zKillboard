...
if ($groupsPopulated === true && date("H") % 12 != 0 && date("i") != 25) exit;
...
if ($newGroups > 0) Log::irc("Added $newGroups new groupIDs");
if ($newItems > 0) Log::irc("Added $newItems new typeIDs");
