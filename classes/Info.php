...
class Info
{
    ...
    public static function getCorpDetails($id, $parameters = array())
    {
        ...
        if ($data != null) {
            $data['corporationID'] = (int) $id;
        }
        if ($data != null) {
            $data['corporationName'] = $data['name'];
        }
        if ($data != null) {
    ...
    public static function getAlliDetails($id, $parameters = array())
    {
        ...
        if ($data != null) {
            $data['allianceID'] = (int) $id;
        }
        if ($data != null) {
            $data['allianceName'] = @$data['name'];
        }
        if ($data != null) {
            ...
            if (is_array($value)) {
                ...
                case 'shipTypeID':
                    if (!isset($element['shipName'])) {
                        $element['shipName'] = self::getItemName($value);
                    }
                    if (!isset($element['groupID'])) {
                        $element['groupID'] = self::getGroupID($value);
                    }
                    if (!isset($element['groupName'])) {
                        $element['groupName'] = self::getGroupName($element['groupID']);
                    }
                    break;
                case 'groupID':
                    global $loadGroupShips; // ugh
                    if (!isset($element['groupName'])) {
                        $element['groupName'] = self::getGroupName($value);
                    }
                ...
                case 'typeID':
                    if (!isset($element['typeName'])) {
                        $element['typeName'] = self::getItemName($value);
                    }
                    ...
                    if (!isset($element['groupName'])) {
                        $element['groupName'] = self::getGroupName($groupID);
                    }
