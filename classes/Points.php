...
class Points
{
    private static $pointsArray = array(
	    ...
	    1538 => array('Force Auxiliary Group', 3000),
            ...
            941 => array('Industrial Command Ship', 200),
	    ...
	    1276 => array('Mobile Micro Jump Unit', 10),
