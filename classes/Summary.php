...
class Summary
{
	...
	public static function getSummary($type, $column, &$data, $id, $parameters = array(), $overRide = false)
	{
		...
		if ($type == "pilot") $type = "characterID";
		else if ($type == "corp") $type = "corporationID";
		else if ($type == "alli") $type = "allianceID";
		else if ($type == "faction") $type = "factionID";
		else if ($type == "ship") $type = "shipTypeID";
		else if ($type == "system") $type = "solarSystemID";
		else if ($type == "region") $type = "regionID";
