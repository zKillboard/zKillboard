...
$routes = [
	...
	'/cache/{cacheType:bypass|1hour|24hour|tagged}/killlist/' => ['GET', 'view/ajax/killlist.php'],
	'/cache/{cacheType:bypass|1hour|24hour|tagged}/statstop10/' => ['GET', 'view/ajax/statstop10.php'],
	'/cache/{cacheType:bypass|1hour|24hour|tagged}/statstopisk/' => ['GET', 'view/ajax/statstopisk.php'],
