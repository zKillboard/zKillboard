...
$app->get('/kill/:id/remaining/', function ($id, $where = '', $pageview = 'remaining') use ($app) {
	include 'view/detail.php';
});
$app->get('/kill/:id/', function ($id, $where = '', $pageview = '') use ($app) {
	include 'view/detail.php';
});
$app->get('/kill/:id/ingamelink/', function ($id) use ($app) {
...
$app->get('/api/recentactivity/', function () use ($app) {
	include 'view/api/recentactivity.php';
});
$app->post('/api/killmail/add/:killID/:hash/', function ($killID, $hash) use ($app) {
...
$app->get('/scanalyzer/', function () use ($app) {
	include 'view/scanalyzer.php';
});
$app->post('/cache/bypass/scan/', function () use ($app) {
	include 'view/scanp.php';
});

$app->get('/cache/bypass/stats/', function () use ($app) {
	include 'view/ajax/stats.php';
});
$app->get('/cache/1hour/stats/', function () use ($app) {
	include 'view/ajax/stats.php';
});
$app->get('/cache/24hour/stats/', function () use ($app) {
	include 'view/ajax/stats.php';
});

$app->get('/cache/bypass/killlist/', function () use ($app) {
	include 'view/ajax/killlist.php';
});
$app->get('/cache/1hour/killlist/', function () use ($app) {
	include 'view/ajax/killlist.php';
});
$app->get('/cache/24hour/killlist/', function () use ($app) {
	include 'view/ajax/killlist.php';
});

$app->get('/cache/bypass/statstop10/', function () use ($app) {
	include 'view/ajax/statstop10.php';
});
$app->get('/cache/1hour/statstop10/', function () use ($app) {
	include 'view/ajax/statstop10.php';
});
$app->get('/cache/24hour/statstop10/', function () use ($app) {
	include 'view/ajax/statstop10.php';
});

$app->get('/cache/bypass/statstopisk/', function () use ($app) {
	include 'view/ajax/statstopisk.php';
});
$app->get('/cache/1hour/statstopisk/', function () use ($app) {
	include 'view/ajax/statstopisk.php';
});
$app->get('/cache/24hour/statstopisk/', function () use ($app) {
	include 'view/ajax/statstopisk.php';
});
...
$app->get('/cache/24hour/killlistrow/:killID/', function ($killID) use ($app) {
	include 'view/killlistrow.php';
});
$app->get('/cache/bypass/healthcheck/', function () use ($app) {
