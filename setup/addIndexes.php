...
echo "Done\n";
echo "Creating index : 'war_eligible' => 1, with sparse = 1 and unique = 0 ... ";
$information->ensureIndex(array('war_eligible' => 1), array("sparse" => 1, "unique" => 0));
echo "Done\n";
...
$information->ensureIndex(array('type' => 1, 'corporationID' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : 'type' => 1, 'lastAffUpdate' => 1, with sparse = 0 and unique = 0 ... ";
$information->ensureIndex(array('type' => 1, 'lastAffUpdate' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
echo "Done\n";
echo "Creating index : 'system.constellationID' => 1, 'sequence' => 1, with sparse = 0 and unique = 0 ... ";
$killmails->ensureIndex(array('system.constellationID' => 1, 'sequence' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
echo "Done\n";
echo "Creating index : 'system.regionID' => 1, 'sequence' => 1, with sparse = 0 and unique = 0 ... ";
$killmails->ensureIndex(array('system.regionID' => 1, 'sequence' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
echo "Done\n";
echo "Creating index : 'locationID' => 1, 'sequence' => 1, with sparse = 1 and unique = 0 ... ";
$killmails->ensureIndex(array('locationID' => 1, 'sequence' => 1), array("sparse" => 1, "unique" => 0));
echo "Done\n";
echo "Creating index : 'system.constellationID' => 1, 'killID' => -1, with sparse = 0 and unique = 0 ... ";
$killmails->ensureIndex(array('system.constellationID' => 1, 'killID' => -1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : 'labels' => 1, 'sequence' => 1, with sparse = 0 and unique = 0 ... ";
$killmails->ensureIndex(array('labels' => 1, 'sequence' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
echo "Done\n";
echo "Creating index : 'player_donation' => 1, 'dttm' => 1, with sparse = 0 and unique = 0 ... ";
$payments->ensureIndex(array('player_donation' => 1, 'dttm' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : '_id' => 1, 'player_donation' => 1, 'dttm' => 1, with sparse = 0 and unique = 0 ... ";
$payments->ensureIndex(array('_id' => 1, 'player_donation' => 1, 'dttm' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : 'monocle_check' => 1, with sparse = 0 and unique = 0 ... ";
$payments->ensureIndex(array('monocle_check' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : 'characterID' => 1, with sparse = 0 and unique = 0 ... ";
$payments->ensureIndex(array('characterID' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
echo "Done\n";
echo "Creating index : 'reset' => 1, with sparse = 0 and unique = 0 ... ";
$statistics->ensureIndex(array('reset' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : 'id' => 1, with sparse = 0 and unique = 0 ... ";
...
echo "Done\n";
echo "Creating index : 'todo' => 1, with sparse = 1 and unique = 0 ... ";
$statistics->ensureIndex(array('todo' => 1), array("sparse" => 1, "unique" => 0));
echo "Done\n";
...
echo "Done\n";
echo "Creating index : 'character_id' => 1, with sparse = 0 and unique = 1 ... ";
$twitch->ensureIndex(array('character_id' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
echo "Creating index : 'twitch_id' => 1, with sparse = 0 and unique = 1 ... ";
$twitch->ensureIndex(array('twitch_id' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
echo "Creating index : 'character_id' => 1, 'twitch_id' => 1, with sparse = 0 and unique = 1 ... ";
$twitch->ensureIndex(array('character_id' => 1, 'twitch_id' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
echo "Creating index : 'expires' => 1, with sparse = 0 and unique = 0 ... ";
$twitch->ensureIndex(array('expires' => 1), array("sparse" => 0, "unique" => 0, "expireAfterSeconds" => 3600));
echo "Done\n";
