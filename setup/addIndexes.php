...
$activity->createIndex(array('id' => 1, 'day' => 1, 'hour' => 1, 'killID' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
echo "Creating index : 'id' => 1, 'day' => 1, 'hour' => 1, with sparse = 0 and unique = 0 ... ";
$activity->createIndex(array('id' => 1, 'day' => 1, 'hour' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : 'dttm' => 1, with sparse = 0 and unique = 0 ... ";
$activity->createIndex(array('dttm' => 1), array("sparse" => 0, "unique" => 0, "expireAfterSeconds" => 7776000));
echo "Done\n";
...
$comments->createIndex(array('upvotes' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
echo "Creating index : 'commentID' => 1, with sparse = 0 and unique = 0 ... ";
$comments->createIndex(array('commentID' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
$information->createIndex(array('lastApiUpdate' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
$killmails->createIndex(array('campaigns' => 1), array("sparse" => 1, "unique" => 0));
echo "Done\n";
echo "Creating index : 'sponsored' => 1, with sparse = 1 and unique = 0 ... ";
$killmails->createIndex(array('sponsored' => 1), array("sparse" => 1, "unique" => 0));
echo "Done\n";
...
$padhash->createIndex(array('characterID' => 1, 'isVictim' => 1, 'hash' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
echo "Creating index : 'characterID' => 1, 'isVictim' => 1, 'count' => 1, with sparse = 0 and unique = 0 ... ";
$padhash->createIndex(array('characterID' => 1, 'isVictim' => 1, 'count' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";

// patreon
echo "\nCreating collection patreon ... ";
$patreon = $db->createCollection("patreon");
echo "Done\n";
echo "Creating index : 'patreon_id' => 1, with sparse = 0 and unique = 1 ... ";
$patreon->createIndex(array('patreon_id' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
echo "Creating index : 'character_id' => 1, with sparse = 0 and unique = 1 ... ";
$patreon->createIndex(array('character_id' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
echo "Creating index : 'character_id' => 1, 'expires' => 1, with sparse = 0 and unique = 0 ... ";
$patreon->createIndex(array('character_id' => 1, 'expires' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
$prices->createIndex(array('typeID' => 1), array("sparse" => 0, "unique" => 1));
echo "Done\n";
...
$scopes->createIndex(array('corporationID' => 1, 'scope' => 1, 'lastFetch' => 1), array("sparse" => 0, "unique" => 0));
echo "Done\n";
...
$statistics->createIndex(array('calcAlltime' => 1), array("sparse" => 1, "unique" => 0));
echo "Done\n";
echo "Creating index : 'calcAlltime' => 1, 'shipsDestroyed' => 1, with sparse = 1 and unique = 0 ... ";
$statistics->createIndex(array('calcAlltime' => 1, 'shipsDestroyed' => 1), array("sparse" => 1, "unique" => 0));
echo "Done\n";

// structures
echo "\nCreating collection structures ... ";
$structures = $db->createCollection("structures");
echo "Done\n";
