...
$apimails->ensureIndex(array('killID' => 1), array('sparse' => 0, 'unique' => 1));
echo "Done\n";
...
echo "Done\n";
echo "Creating index : 'userID' => 1, 'keyID' => 1, 'vCode' => 1, with sparse = 0 and unique = 1 ... ";
$apis->ensureIndex(array('userID' => 1, 'keyID' => 1, 'vCode' => 1), array('sparse' => 0, 'unique' => 1));
echo "Done\n";
...
$itemmails->ensureIndex(array('dttm' => 1), array('sparse' => 0, 'unique' => 0));
echo "Done\n";
...
// stompmails
echo "\nCreating collection stompmails ... ";
$stompmails = $db->createCollection('stompmails');
echo "Done\n";
echo "Creating index : 'killID' => 1, with sparse = 0 and unique = 1 ... ";
$stompmails->ensureIndex(array('killID' => 1), array('sparse' => 0, 'unique' => 1));
echo "Done\n";
