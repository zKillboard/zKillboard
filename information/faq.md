...
- <span class="badge zkb-label-danger text-white">AWOX (1)</span>: During the past year, the character dealt the final blow to a member of their own player corporation, or to another pilot enlisted in the same faction. The number is how many qualifying final blows were recorded.
