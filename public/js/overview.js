...
function isOverviewPathname(pathname) {
	return /^\/(?:character|corporation|alliance|faction|ship|group|system|region|location)\/\d+\/(kills|losses|solo|stats|wars|supers|trophies|ranks|top|topalltime|streambox|corpstats)?\/?$/.test(pathname);
}
