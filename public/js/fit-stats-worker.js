import * as engine from '../vendor/eveshipfit/esf_dogma_engine_bg.js?v=10.3.0';
...
async function loadData() {
    ...
    const wasmResponse = await fetch(new URL('../vendor/eveshipfit/esf_dogma_engine_bg.wasm?v=10.3.0', import.meta.url));
