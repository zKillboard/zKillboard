...
function handler($request, $response, $args, $container) {
	...
	$data = array(
		'topPods' => $topPods, 
		'topIsk' => $topIsk, 
		'topIskShips' => $topIskShips, 
		'topIskStructures' => $topIskStructures, 
		'topPoints' => $topPoints, 
		'topSpecialLosses' => $topSpecialLosses, 
		'topKillers' => $top, 
		'kills' => $kills, 
		'page' => $page, 
		'pageType' => $pageType, 
		'pager' => true, 
		'pageTitle' => $pageTitle, 
		'requestUriPager' => $requestUriPager, 
		'activePvP' => $activePvP, 
		'entityID' => '*', 
		'trackedItems' => $trackedItems, 
		'topDonators' => json_decode($redis->get("zkb:topDonators"), true), 
		'sponsored' => $sponsored
	);

	return $container->get('view')->render($response->withHeader('Cache-Control', 'max-age=60')->withHeader('Cache-Tag', 'www,index'), 'index.pug', $data);
}
