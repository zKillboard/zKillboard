...
$extra['totalprice'] = Helper::iskToUsdEurGbp($killdata['info']['zkb']['totalValue']);
$extra['destroyedprice'] = Helper::iskToUsdEurGbp($extra['lostisk']);
$extra['droppedprice'] = Helper::iskToUsdEurGbp($extra['droppedisk']);
$extra['fittedprice'] = Helper::iskToUsdEurGbp($extra['fittedisk']);
