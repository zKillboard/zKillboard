...
function handler($request, $response, $args, $container) {
    ...
    try {
        ...
        return $container->get('view')->render($response->withHeader('Cache-Tag', "sponsor,kill:$killID"), "sponsor.html", ['killID' => $killID, 'iskA' => $iskAvailable, 'response' => $responseMessage, 'valueF' => $valueF, 'type' => $type]);
    } catch (Exception $e) {
        Util::zout(print_r($e, true));
        return $container->get('view')->render($response->withHeader('Cache-Tag', 'error,sponsor'), "error.html", ['message' => 'An error occurred processing your request.']);
    }
}
