...
function handler($request, $response, $args, $container)
{
	...
	$nameOverrides = [
		...
		'awox' => 'Awox', 'a:awox' => 'Alliance Awox', 'f:awox' => 'Faction Awox',
	...
	$descriptionOverrides = [
		...
		'awox' => 'The final-blow attacker and victim share a player corporation.',
		'a:awox' => 'The final-blow attacker and victim share an alliance.',
		'f:awox' => 'The final-blow attacker and victim share a faction.',
		...
		'super' => 'A supercarrier appears as the victim or an attacker.',
		'titan' => 'A titan appears as the victim or an attacker.',
	...
	$labelColors = [
		...
		'pvp' => '#285c00', 'npc' => '#3f3f3f', 'awox' => '#781500', 'a:awox' => '#781500', 'f:awox' => '#781500', 'ganked' => '#6b2f45', 'padding' => '#604515',
	...
	foreach ($labels as $label => $labelData) {
		...
		else if (in_array($label, ['pvp', 'npc', 'awox', 'a:awox', 'f:awox', 'ganked', 'padding'], true)) $group = 'type';
