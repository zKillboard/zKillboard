...
function handler($request, $response, $args, $container) {
    ...
    if ($info == null) {
        return $container->get('view')->render($response->withStatus(404)->withHeader('Cache-Tag', "www,error,404,item,type:$id"), '404.pug', ['message' => 'Item not found']);
    }
    ...
    $doc = $mdb->findDoc('killmails', ['involved.shipTypeID' => (int) $id]);
    $hasKills = $doc !== null;
    ...
    return $container->get('view')->render($response->withHeader('Cache-Tag', "www,item,type:$id"), 'item.pug', $data);
}
